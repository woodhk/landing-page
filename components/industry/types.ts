...
export type CrossIndustrySlug = 'administrative-support' | 'customer-support-staff' | 'operations-project-management' | 'marketing-communications' | 'it-technical-support' | 'finance';
