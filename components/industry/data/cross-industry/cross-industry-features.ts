...
export const crossIndustryFeaturesData: CrossIndustryFeaturesData[] = [
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps administrative support professionals develop the language skills needed for effective workplace communication.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps customer support professionals develop the language skills needed for effective client interactions.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps operations and project management professionals develop the language skills needed for effective team coordination.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps marketing and communications professionals develop the language skills needed for effective content creation and promotion.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps IT and technical support professionals develop the language skills needed for effective technical communication.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps finance professionals develop the language skills needed for effective financial communication.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps HR and onboarding professionals develop the language skills needed for effective talent management.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps client relationship professionals develop the language skills needed for effective account management.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps sales and business development professionals develop the language skills needed for effective selling.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps learning and development professionals enhance their language skills for effective training delivery.',
      features: [
        {
  ...
  },
  {
    ...
    features: {
      ...
      mainDescription: 'Our program helps team and department leaders develop the language skills needed for effective leadership.',
      features: [
        {
