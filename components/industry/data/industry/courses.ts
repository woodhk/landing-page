...
export const bankingFinanceCourses: CoursesSection = {
  sectionTitle: 'Banking & Finance Courses for Any Role',
  sectionDescription: 'From Bank Tellers to Investment Bankers, we offer scenario-based courses tailored to each job role. If staffs job title aren\'t covered, our language experts will create a custom course for free.',
  ...
  courseCards: [
    {
      ...
      imageUrl: '/images/accountants.png',
    ...
    },
    {
      ...
      imageUrl: '/images/bank-teller.png',
    ...
    },
    {
      ...
      imageUrl: '/images/investment-banker.png',
      outlineLink: '/industry/banking-finance/courses/investment-bankers',
    },
    {
      title: 'Other',
      description: 'Don\'t see your specific banking or finance role listed? Our language experts will create a custom course for your team within 48 hours, at no extra cost.',
      imageUrl: '/images/banking-yourIndustry.png',
