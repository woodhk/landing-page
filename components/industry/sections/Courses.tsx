  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden h-full flex flex-col transform transition-all duration-300 hover:shadow-lg">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="p-8 md:w-1/2 flex flex-col justify-center bg-white h-full">
          <div>
          ...
          <div>
            ...
            >
              ...
              {course.title === "Other" ? "View Covered Roles" : "Download Course Outline"}
            </Link>
          </div>
        </div>
      </div>
    ...
    <section className="w-full py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-5xl md:text-7xl font-bold mb-4 text-gray-900 tracking-tight">
            {sectionTitle}
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {/* Custom courses link moved below navigation */}
