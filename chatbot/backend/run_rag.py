...
def run_rag_with_examples():
    ...
    examples = [
        "What is FluentPro and what does it do?",
        "What features does FluentPro offer to its users?",
        "Who is the parent company of FluentPro?",
        "How can companies implement FluentPro for their employees?",
    ]
...
if __name__ == "__main__":
    # Comment/uncomment one of these to run either the interactive version or examples
    run_rag_interactive()
