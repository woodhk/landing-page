...
// Feature card component with configurable static displays
const FeatureCard = ({ title, description, icon, imagePath, highlight, id }: FeatureCardProps & { id: number }) => {
  ...
  // Image cards show image with title and bullet points
  if (isImageCard) {
    return (
      <div 
      ...
      >
        ...
        <div className="h-full w-full">
          ...
          {/* Larger blur area that includes the heading */}
          <div 
          ...
          {/* Title and bullet points at the bottom */}
  ...
  return (
    ...
    >
      ...
      {highlight && (
        <div className="mb-3">
          <span className="text-5xl font-bold text-blue-500">{highlight}</span>
        </div>
      )}
  ...
  return (
    <div className="bg-gray-100 rounded-xl shadow-sm p-6 flex flex-col h-full border border-gray-100">
      ...
      <div className="flex-grow flex flex-col justify-center">
        <div className="text-6xl font-bold text-blue-500 mb-2 leading-none">{value}</div>
  ...
  return (
    <div className="rounded-xl shadow-sm h-full relative overflow-hidden">
      ...
      <div className="relative h-full w-full">
        ...
        {/* Header content */}
        <div className="absolute top-0 left-0 right-0 p-6 bg-gradient-to-b from-blue-900/70 to-transparent">
          <div className="flex items-center mb-4">
            <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mr-4 shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="#0064E5" className="text-blue-500">
        ...
        <div className="absolute inset-x-0 bottom-0 flex items-end justify-center p-6 bg-gradient-to-t from-blue-900/70 to-transparent">
          <a 
            href="https://language-key.vercel.app/home" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center bg-white hover:bg-blue-50 text-blue-600 font-medium py-3 px-6 rounded-lg transition-all duration-300 shadow-lg w-full"
          >
  ...
  const roiMetrics = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="#0064E5" className="text-blue-500">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      )
    },
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-semibold bg-blue-100 text-blue-700 shadow-sm mb-4">
          ...
          <h2 className="text-3xl md:text-6xl font-bold text-gray-900 mb-4">
            Designed To Maximize <span className="text-blue-600 font-bold">ROI</span>
          </h2>
