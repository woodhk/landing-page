...
import { industryData, IndustryData } from '../data/industry';
...
type IndustryRefs = { [key: string]: HTMLDivElement | null };
...
/**
 * Mobile view industry list props
 */
interface MobileIndustryListProps {
...
/**
 * Desktop industry list props
 */
interface DesktopIndustryListProps {
...
/**
 * Desktop industry details props
 */
interface DesktopIndustryDetailsProps {
  industry: IndustryData;
}
...
/**
 * Desktop client logos props
 */
interface DesktopClientLogosProps {
 ...
 */
const IndustryAnimation: React.FC<{ industryId: string }> = ({ industryId }) => {
  switch(industryId) {
...
/**
 * Returns an icon component based on industry ID
 */
...
const getMobileIndustryHeaderClass = (industryId: string, expandedIndustry: string | null) => {
  if (expandedIndustry !== industryId) {
...
const getMobileIndustryIconClass = (industryId: string, expandedIndustry: string | null) => {
...
const getDesktopIndustryIconClass = (industryId: string, selectedIndustry: string) => {
...
const getDesktopIndustryTextClass = (industryId: string, selectedIndustry: string) => {
 ...
 */
const formatIndustryTitle = (industryId: string): string => {
