...
export const InviteStaff = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-white p-6 relative">
      ...
      <div className="w-full max-w-[500px] bg-white rounded-lg shadow-sm relative z-10">
        {/* Header - Compact */}
          ...
          {activeTab === 'quick' ? (
            <div className="w-full">
              ...
              <div className="w-full flex items-center space-x-2 mb-3">
                ...
                <button
                  onClick={handleCopy}
                  className="px-3 py-2 bg-white border border-gray-200 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50"
                >
                  {isCopied ? 'Copied!' : 'Copy'}
                </button>
              </div>
              
              <button className="w-full px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 flex items-center justify-center">
            ...
            <div className="h-[120px] flex flex-col items-center justify-center text-gray-400 space-y-1">
