...
export const keyValueData: KeyValueItem[] = [
  {
    ...
    description: "Teaching staff the correct industry-specific terms and professional phrasing, ensuring they can professionally handle real-world workplace conversations.",
  ...
  },
  {
    ...
    description: "Helping staff communicate with the right level of formality and tone for each business scenario, making them sound professional, respectful, and suited to the workplace context.",
  ...
  },
  {
    ...
    description: "Helping staff navigate cultural differences in communication by providing feedback on language use, etiquette, and expressions, making their responses align with professional and culturally aware business interactions.",
