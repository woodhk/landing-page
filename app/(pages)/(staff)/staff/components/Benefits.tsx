    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto mb-20 md:mb-28 text-center space-y-4">
          <motion.h2 
            className=" text-3xl md:text-4xl lg:text-7xl font-light tracking-tight text-gray-900 leading-tight"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
          >
            <span className="font-medium">Practical Training</span> for your organization
          </motion.h2>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <p className="text-2xl text-gray-500 max-w-4xl mx-auto">
              A language training solution that delivers content staff can use at work tomorrow.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div className="relative h-full flex items-center justify-center">
              <div className="rounded-2xl border border-gray-200 p-3 w-full shadow-sm scale-105">
                <Image 
