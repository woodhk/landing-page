    ...
    <div className="relative">
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 items-center py-4 md:py-8 pb-12 md:pb-32 md:pt-32 px-4 sm:px-6 lg:px-4 max-w-7xl mx-auto">
        <div className="flex flex-col space-y-4 md:space-y-6 max-w-[560px]">
          <div>
          <span className="inline-block px-3 py-1 text-sm font-medium text-dynamic-blue bg-blue-100 rounded-full mb-4">Training & Onboarding</span>
            <h1 className="text-4xl sm:text-4xl md:text-6xl font-bold text-dark mb-3">
              Start Staff Training in Minutes Not Days
            </h1>
          </div>
          
          <div>
            <p className="text-xl font-medium text-gray-900">
              Getting your team started is effortless—just send one email. Our magic link connects staff to your dashboard instantly, with no extra steps or wasted time.
            </p>
          </div>
        ...
        <div className="hidden lg:flex h-full items-center justify-center">
          <div className="relative p-4 w-full">
            <Image
              src="/app-screenshots/manageAccount.png"
              alt="Scenarios Homepage Screenshot"
              width={1600}
              height={1600}
              className="w-full h-auto max-w-lg mx-auto transform scale-[1.3] hover:scale-[1.4] transition-transform duration-300 rounded-xl shadow-xl"
              priority
            />
          </div>
        </div>
