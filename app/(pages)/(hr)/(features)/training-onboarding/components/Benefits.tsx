...
const headingText = "Send One Email to Invite All Your Staff";
    ...
    <section className="w-full py-20 bg-white">
      <div className="container mx-auto px-4">
        <h1 
          ...
          className="text-center text-4xl lg:text-7xl max-w-3xl mx-auto font-bold text-gray-900 mb-16 flex flex-wrap items-center justify-center"
        ...
        <div className="flex justify-center mb-16">
          <Image 
            src="/app-screenshots/inviteStaff.png"
            alt="Invite Staff Interface"
            width={700}
            height={400}
